...
project = os.getenv('GOOGLE_CLOUD_PROJECT') or 'dc-99999'
...
create_instance(service,project,zone,instance_name_template,"dc-sitesh")
set_tag(service,"dc-99999","us-west1-b","demo-instance2")
